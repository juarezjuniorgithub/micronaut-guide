# Windows -> Develop with Oracle Database 23ai and GraalVM using Micronaut
...
# Linux with Oracle Cloud Shell -> Develop with Oracle Database 23ai and GraalVM using Micronaut
